...
#' @param by merge by single column
#' @param by.x merge by column in x
#' @param by.y merge by column in y
#' @param sort whether to sort the column (defaults to FALSE)
#' @param keep_order keep order in x (1) or y (2)
